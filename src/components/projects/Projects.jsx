            ...
            <h2 className='text-center pt-4'>Projects</h2>
                <Row md={4} className="project-row" >
                    ...
                    <h3 className='project-title '>Video Game Sales</h3>
                        ...
                        <div className='mb-2'><span className='tech'>HTML5</span>
                        <span className='tech'>CSS3</span>
                        <span className='tech'>Node</span>
                        <span className='tech'>D3js</span><br/></div>
                         <div> 
                             <span className='tech my-1'>Charts</span>
                             {/* <span className='tech'>Recharts</span> */}
                             {/* <span className='tech'>MUI</span> */} 
                         </div>
                    ...
                    <h3 className='project-title '>Travel</h3>
                        ...
                        <br/></div>
                         <div> 
                             <span className='tech my-1'>Animations</span>
                             {/* <span className='tech'></span>
                             <span className='tech'></span>  */}
                         </div>
                ...
                <h6 className='text-center py-5  git-repos'><a className="git-link" href="https://github.com/vijaykumarvemana?tab=repositories" target="_blank">Repositories on GitHub</a></h6>
                </section>
      </Element>
    )
}
